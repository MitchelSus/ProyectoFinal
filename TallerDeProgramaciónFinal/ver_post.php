...
?>
   ...
   <form action="" method="POST">
      ...
      <div class="inline-option-btn" onclick="window.location.href = 'view_post.php?post_id=<?= $get_id; ?>';">cancelar</div>
   </form>
   </section>
<?php
   }
...
<section class="posts-container" style="padding-bottom: 0;">
   ...
   <div class="box-container">
      ...
      <?php
         ...
         echo '<p class="empty">profe no encontrado</p>';
      }
      ?>
   </div>
...
<section class="comments-container">
   ...
   <p class="comment-title">agregar un comentario</p>
   <?php
      if($user_id != ''){  
   ...
   <form action="" method="post" class="add-comment">
      ...
      <p class="user"><i class="fas fa-user"></i><a href="actualizar.php"><?= $fetch_profile['name']; ?></a></p>
      <textarea name="comment" maxlength="1000" class="comment-box" cols="30" rows="10" placeholder="agregar comentario" required></textarea>
      <input type="submit" value="agregar comentario" class="inline-btn" name="add_comment">
   </form>
   <?php
   }else{
   ?>
   <div class="add-comment">
      <p>por favor inicie sesión para agregar o editar su comentario</p>
      <a href="inciciar.php" class="inline-btn">¡iniciar sesión!</a>
   </div>
   <?php
      }
   ?>
   
   <p class="comment-title">comentarios del profe</p>
   <div class="user-comments-container">
      ...
      <div class="show-comments" style="<?php if($fetch_comments['user_id'] == $user_id){echo 'order:-1;'; } ?>">
         ...
         <form action="" method="POST">
            ...
            <button type="submit" class="inline-delete-btn" name="delete_comment" onclick="return confirm('¿Quieres borrar este comentario?');">cancelar</button>
         </form>
         <?php
         }
         ?>
