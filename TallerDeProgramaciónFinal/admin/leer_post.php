...
<section class="read-post">
   ...
   <form method="post">
      ...
      <div class="flex-btn">
         <a href="editar_post.php?id=<?= $post_id; ?>" class="inline-option-btn">editar</a>
         <button type="submit" name="delete" class="inline-delete-btn" onclick="return confirm('¿Quieres borrar este profe?');">borrar</button>
         <a href="ver_posts.php" class="inline-option-btn">regresar</a>
      </div>
   </form>
   <?php
         }
