...
if(isset($_POST['delete'])){
   ...
   $message[] = '¡profe borrado correctamente!';
...
<section class="show-posts">
   ...
   <h1 class="heading">tus publicaciones</h1>
   ...
   <div class="box-container">
      ...
      <form method="post" class="box">
         ...
         <div class="flex-btn">
            <a href="editar_post.php?id=<?= $post_id; ?>" class="option-btn">editar</a>
            <button type="submit" name="delete" class="delete-btn" onclick="return confirm('¿Quieres borrar al PROFE?');">borrar</button>
         </div>
         <a href="leer_post.php?post_id=<?= $post_id; ?>" class="btn">ver profe</a>
      </form>
      <?php
            }
         }else{
            echo '<p class="empty">todavia no se agregarón profes <a href="agregar_profe.php" class="btn" style="margin-top:1.5rem;">add post</a></p>';
         }
      ?>
