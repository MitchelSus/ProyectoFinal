...
if(isset($_POST['delete'])){
   ...
   header('location:../components/admin_cerrar.php');
}
...
<section class="accounts">
   ...
   <div class="box" style="order: -2;">
      ...
      <a href="registrar_admin.php" class="option-btn" style="margin-bottom: .5rem;">registrar</a>
   </div>
   ...
   <div class="box" style="order: <?php if($fetch_accounts['id'] == $admin_id){ echo '-1'; } ?>;">
      ...
      <p> Publicacione Totales : <span><?= $total_admin_posts; ?></span> </p>
      <div class="flex-btn">
         <?php
            if($fetch_accounts['id'] == $admin_id){
         ?>
            <a href="actualizar_perfil.php" class="option-btn" style="margin-bottom: .5rem;">Actualizar</a>
            <form action="" method="POST">
               <input type="hidden" name="post_id" value="<?= $fetch_accounts['id']; ?>" on>
               <button type="submit" name="delete"onclick="return confirm('¿Quieres borrar esta cuenta?');" class="delete-btn" style="margin-bottom: .5rem;">borrar</button>
            </form>
         <?php
            }
         ?>
