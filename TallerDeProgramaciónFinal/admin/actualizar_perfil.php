...
if(isset($_POST['submit'])){
   ...
   if($old_pass != $empty_pass){
      if($old_pass != $prev_pass){
         $message[] = '¡la contraseña antiguaghgg, no conciden!';
...
<section class="form-container">
   ...
   <form action="" method="POST">
      ...
      <input type="password" name="old_pass" maxlength="20" placeholder="Ingresa Tu Contraseña Antigua" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
      <input type="password" name="new_pass" maxlength="20" placeholder="Ingresa Tu Nueva Contraseña" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
