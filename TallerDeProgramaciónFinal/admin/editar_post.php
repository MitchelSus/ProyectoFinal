...
if(isset($_POST['save'])){
   ...
   if(!empty($image)){
      if($image_size > 2000000){
         ...
         $message[] = '¡por favor renombra laa imagen!';
      }else{
...
<section class="post-editor">
   ...
   <h1 class="heading">editar profe</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex-btn">
         ...
         <a href="ver_posts.php" class="option-btn">go back</a>
   ...
   ?>
   <div class="flex-btn">
      <a href="ver_posts.php" class="option-btn">ver profes</a>
      <a href="agregar_profe.php" class="option-btn">agregar profes</a>
   </div>
   <?php
      }
   ?>
