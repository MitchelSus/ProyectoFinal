...
<section class="posts-container">
   ...
   <div class="box-container">
      ...
      <form class="box" method="post">
         ...
         <a href="ver_post.php?post_id=<?= $post_id; ?>" class="inline-btn">read more</a>
         <div class="icons">
            <a href="ver_post.php?post_id=<?= $post_id; ?>"><i class="fas fa-comment"></i><span>(<?= $total_post_likes; ?>)</span></a>
      ...
      <?php
            ...
            echo '<p class="empty">profe no encontrado para este categoría</p>';
         }
         }
      }else{
